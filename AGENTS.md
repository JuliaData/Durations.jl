...
Read README.md before changing the API. Keep Int32/Int32/Int64 fields at offsets 0/4/8. Preserve independent components and mixed signs. Arithmetic checks overflow. Keep only Duration and Timestamp exported. Avoid context-free calendar normalization and ordering.
